            ...
            {% if accounts %}
                <div class="account-filter">
                    <form method="get" action="/">
                        ...
                        <input type="date" name="start_date" value="{% if start_date %}{{ start_date }}{% endif %}" onchange="this.form.submit()">
                        <label for="end_date">To:</label>
                        <input type="date" name="end_date" value="{% if end_date %}{{ end_date }}{% endif %}" onchange="this.form.submit()">
                    </form>
                </div>
            {% endif %}
        </div>
...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        #debug-btn { padding: 12px 24px; background: #6c757d; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 1rem; font-weight: 500; margin-left: 10px; }
        #debug-btn:hover { opacity: 0.9; }
